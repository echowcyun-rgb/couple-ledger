...
export const INIT_CATS: Category[] = [
  ...
  { key: "pet", glyph: "🐾", label: "宠物", type: "out" },
  { key: "beauty", glyph: "💆", label: "医美", type: "out" },
  { key: "cosmetics", glyph: "💄", label: "化妆品", type: "out" },
  { key: "social", glyph: "🧧", label: "人情", type: "out" },
  { key: "vehicle", glyph: "🚗", label: "汽车", type: "out" },
